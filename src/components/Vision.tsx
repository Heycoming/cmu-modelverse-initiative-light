...
const PricingCard = ({ title, price, subtitle, icons }: { title: string, price: string, subtitle: string, icons?: any[] }) => (
  <div className="w-full max-w-3xl mx-auto mb-6 bg-[#1a1525]/80 backdrop-blur-md border border-white/10 rounded-[24px] p-6 flex flex-col md:flex-row items-center justify-between hover:bg-[#251d35]/90 transition-all duration-300 group shadow-xl">
    <div className="flex items-center gap-6 text-center md:text-left mb-4 md:mb-0">
      <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center border border-white/10 group-hover:border-[#C41230]/50 transition-colors">
      ...
      <div>
        ...
        {icons && (
          <div className="flex gap-2 mt-2 justify-center md:justify-start">
            {icons.map((_, i) => (
              <div key={i} className="w-4 h-4 bg-gray-700 rounded-sm group-hover:bg-gray-600 transition-colors"></div>
            ))}
          </div>
        )}
      </div>
...
const Vision = () => {
  return (
    <section id="vision" className="py-24 bg-[#050505]">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mb-24">
          <h2 className="text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-gray-500 tracking-tight">Our Evolution Roadmap</h2>
        ...
        >
          <div className="order-2 lg:order-1">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#C41230]/10 flex items-center justify-center">
            ...
            <h3 className="text-4xl font-bold mb-6 text-white leading-tight">Compute × Data Matchmaking for AI Training</h3>
          ...
          <div className="order-1 lg:order-2">
            <img src="/media/phase1-matchmaking.png" alt="Phase 1 Concept" className="w-full rounded-3xl border border-white/5 shadow-2xl" />
          </div>
        </motion.div>
        ...
        >
          <div className="text-center max-w-4xl mx-auto mb-16">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <span className="text-sm font-bold tracking-widest text-purple-500 uppercase">Phase 02</span>
            </div>
            <h3 className="text-4xl font-bold mb-6 text-white leading-tight">The AI Bubble: LLMs Are Hitting Their Hard Limits</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            {[
              ...
              <div key={i} className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-purple-500/30 transition-all">
                <h4 className="text-xl font-bold mb-6 text-white flex items-center gap-3">
                  <span className="text-purple-500 text-sm font-mono">{i + 1}.</span>
                  {pillar.title}
                </h4>
                <ul className="space-y-4">
                  {pillar.items.map((item, j) => (
                    <li key={j} className="text-gray-500 text-sm flex gap-3">
          ...
          <div className="py-12 bg-[#080808] rounded-[40px] border border-white/5">
            <h3 className="text-2xl md:text-3xl font-medium text-white text-center mb-12">AI pricing is already segmented by user type</h3>
            <PricingCard 
        ...
        >
          <div>
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-sm font-bold tracking-widest text-blue-500 uppercase">Phase 03</span>
            </div>
            <h3 className="text-4xl font-bold mb-6 text-white leading-tight">Decentralization is the Only Path to AGI</h3>
            ...
            <div className="mt-8 p-6 rounded-2xl bg-blue-500/5 border border-blue-500/10 italic text-blue-200/70">
