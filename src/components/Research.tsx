...
const Research = () => {
  ...
  return (
    <section id="research" className="py-24 bg-modelverse-bg">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="mt-20 p-12 glass-card inline-block max-w-4xl mx-auto">
          ...
          <p className="mt-6 font-bold text-cmu-red">— Prof. Tai Sing Lee</p>
        </div>
      </div>
    </section>
  );
