    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'bg-black/80 backdrop-blur-xl border-b border-white/5 py-4' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10">
          ...
          <a href="https://intelligencecubed.io/" target="_blank" rel="noreferrer" className="px-5 py-2 bg-white text-black text-xs font-bold rounded-full hover:bg-[#C41230] hover:text-white transition-all">
            Intelligence Cubed
          </a>
        </div>
